...
import type { ReplicateError as _ReplicateError, StripeSessionStatus as _StripeSessionStatus, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addUserCredits(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addUserCredits(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async adjustUserCredits(arg0: Principal, arg1: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.adjustUserCredits(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async generateImage(arg0: string): Promise<ReplicateError> {
        if (this.processError) {
            try {
                const result = await this.actor.generateImage(arg0);
                return from_candid_ReplicateError_n3(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async generateVideo(arg0: string): Promise<ReplicateError> {
        if (this.processError) {
            try {
    ...
    async hasReplicateApiKey(): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.hasReplicateApiKey();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_ReplicateError_n3(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _ReplicateError): ReplicateError {
